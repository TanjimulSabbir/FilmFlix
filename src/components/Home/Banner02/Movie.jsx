    ...
    return (
        <div className={`${isSlider && "px-2"}`}>
            <div className={`relative`}>
                <div>
                    <img className="rounded-md mb-2" src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt="" srcSet="" />
                ...
                <p className="absolute top-0 left-0 bg-red-600 inline-block px-5 backdrop-brightness-0">{adult ? "Adult" : "PG"}</p>
            </div>
        </div>
    )
}
