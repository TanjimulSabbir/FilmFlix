...
export default function TvHome() {
  ...
  return (
    <div className="h-full w-full lg:flex bg-black mt-11 lg:mt-0">
      <div className={`absolute lg:hidden ${drawerOpen ? "topSlider" : "rightSlider"} h-12 flex justify-center inset-0 w-full top-12 left-0 z-50`}>
