...
export default function SimilarDetails({ movie, handleCloseModal }) {
    const { id, original_title, release_date, overview, genres, runtime, backdrop_path, vote_average, tagline, spoken_languages, status } = movie || {};
            ...
            <div className='flex space-x-10 justify-center shadow-2xl rounded-2xl bg-gray-400'>
                ...
                <div className='relative w-1/2 px-2 py-7'>
                    ...
                    <div className='flex items-center space-x-5'>
                        ...
                        <Link to={`/movie/${id}`} onClick={() => { handleCloseModal(); scrollToTop() }} className='flex items-center space-x-1 py-2 px-9 rounded-xl border border-green-500 text-green-500 cursor-pointer'>
                            {/* <PiPlayCircleFill/> */}
