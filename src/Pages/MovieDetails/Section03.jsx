...
export default function Section03() {
    ...
    const getCrewInfo = (workType) => {
        ...
        return crewsData
            ...
            .map((crew, index) => (
                <p key={crew.credit_id} className="text-nowrap space-x-2">
    ...
    return (
        <div className="w-full pb-7">
            <div className="flex space-x-5 py-4 border-y border-gray-600">
                ...
                <p className="flex flex-wrap items-center gap-2">{getCrewInfo("Directing")}</p>
            </div>
            <div className="flex space-x-5 py-4 border-b border-gray-600">
                <span className="text-lg font-bold">Production</span>
                <p className="flex flex-wrap items-center gap-2">{getCrewInfo("Production")}</p>
            </div>
            <div className="flex space-x-5 py-4 border-b border-gray-600">
